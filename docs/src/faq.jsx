...
const FAQS = [
  {
    q: {
      zh: "为什么只支持 DeepSeek？能不能换 Claude / GPT？",
      en: "Why DeepSeek only? Can I swap to Claude / GPT?",
    },
    a: {
  ...
  {
    q: {
      zh: "能在内网 / 私有部署的 DeepSeek 上跑吗？",
      en: "Can I point it at a self-hosted / private DeepSeek endpoint?",
    },
    a: {
