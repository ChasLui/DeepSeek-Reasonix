      ...
      <div className="footer-inner">
        <div>
          ...
          <div style={{ display: "flex", gap: 10, marginTop: 18 }}>
            ...
            <a
              className="btn btn-ghost btn-sm"
              href="https://github.com/esengine/DeepSeek-Reasonix/discussions"
              target="_blank"
              rel="noreferrer"
            >
              Discussions
        ...
        <div>
          ...
          <ul>
            <li>
              <a href="index.html#install">{t({ zh: "CLI 安装", en: "Install CLI" }, lang)}</a>
            </li>
            <li>
              <a href="download.html">{t({ zh: "桌面端", en: "Desktop" }, lang)}</a>
            </li>
            <li>
              <a href="index.html#agents">{t({ zh: "三大支柱", en: "Three pillars" }, lang)}</a>
            </li>
            <li>
              <a href="index.html#config">{t({ zh: "配置", en: "Config" }, lang)}</a>
            </li>
          </ul>
        </div>
        <div>
          ...
          <ul>
            ...
            <li>
              <a
                href="https://github.com/esengine/DeepSeek-Reasonix/issues"
                target="_blank"
                rel="noreferrer"
              >
                Issues
            ...
            <li>
              <a
                href="https://github.com/esengine/DeepSeek-Reasonix/blob/main/CONTRIBUTING.md"
                target="_blank"
                rel="noreferrer"
              >
                Contributing
        ...
        <div>
          ...
          <ul>
            <li>
              <a
                href="https://github.com/esengine/DeepSeek-Reasonix#readme"
                target="_blank"
                rel="noreferrer"
              >
                README
            ...
            <li>
              <a
                href="https://github.com/esengine/DeepSeek-Reasonix/blob/main/CHANGELOG.md"
                target="_blank"
                rel="noreferrer"
              >
                Changelog
