    ...
    points: [
      {
        ...
        label: "append-only",
        desc: {
          zh: "消息、工具结果一律尾部追加，绝不修改历史",
          en: "Messages and tool results are appended; history is never mutated",
        },
      },
      {
        n: "02",
        label: "no marker",
        desc: {
          zh: "不使用 cache_control 之类的标记触发器",
          en: "No reliance on triggers like cache_control markers",
        },
      },
      {
        n: "03",
        ...
        desc: {
          zh: "工具调用顺序与时间戳完全确定性",
          en: "Tool call ordering and timestamps are fully deterministic",
        },
      },
      {
        n: "04",
        label: "prefix-survive",
        desc: {
          zh: "即使 dispatch 多次工具，前缀仍命中",
          en: "Even with many tool dispatches, the prefix still hits",
        },
      },
    ],
  },
    ...
    points: [
      {
        ...
        label: "capture",
        desc: {
          zh: "解析 <think> 块，识别其中的 tool-call 语法",
          en: "Parse <think> blocks; recognise tool-call syntax inside them",
        },
      },
      {
        n: "02",
        label: "replay",
        desc: {
          zh: "把抓出的调用重新走 dispatch 通道",
          en: "Replay recovered calls through the dispatch path",
        },
      },
      {
        n: "03",
        label: "effort",
        desc: {
          zh: "/effort 控制推理深度，便宜回合可降级",
          en: "`/effort` tunes reasoning depth; cheap turns drop down",
        },
      },
      {
        n: "04",
        label: "observe",
        desc: {
          zh: "所有 harvest 操作落盘到 events 日志",
          en: "Every harvest action lands in the events log",
        },
      },
    ],
  },
    ...
    points: [
      {
        ...
        label: "parse",
        desc: {
          zh: "JSON5 / 容错解析，识别常见畸形写法",
          en: "JSON5 / lenient parser catches common malformations",
        },
      },
      {
        n: "02",
        label: "reshape",
        desc: {
          zh: "按 schema 重排字段名 · 修补默认值",
          en: "Reshape against the schema; fill in defaults",
        },
      },
      {
        n: "03",
        label: "retry",
        desc: {
          zh: "修复失败时优雅回报 · 让模型自我纠正",
          en: "When repair fails, report cleanly so the model self-corrects",
        },
      },
      {
        n: "04",
        label: "log",
        desc: {
          zh: "所有修复动作可在 reasonix replay 中回放",
          en: "Every repair action is replayable via reasonix replay",
        },
      },
    ],
  },
  ...
  return (
    <section className="section" id="agents">
      <SecHead
        ...
        label="Three Pillars"
        title={t(
          { zh: "为什么是 <em>DeepSeek</em> 原生", en: "Why <em>DeepSeek</em>-native" },
          lang,
        )}
        sub={t(
          {
      ...
      <div className="agents">
        <div className="agent-list">
          {PILLARS.map((a) => (
            <div
              key={a.id}
              className={"agent-item " + (a.id === sel ? "on" : "")}
              onClick={() => setSel(a.id)}
            >
