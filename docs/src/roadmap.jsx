...
const ROADMAP = [
  {
    ...
    items: [
      ...
      {
        zh: "R1 Thought Harvest · 思考逃逸回收",
        en: "R1 Thought Harvest · scavenge escaped tool calls",
      },
  ...
  },
  {
    ...
    items: [
      ...
      {
        zh: "setup-wizard 主题选择 + live preview",
        en: "setup wizard theme picker + live preview",
      },
  ...
  },
  {
    ...
    items: [
      ...
      {
        zh: "Plugin system (Claude .claude-plugin/ 兼容)",
        en: "Plugin system (.claude-plugin/ compatible)",
      },
  ...
  },
  {
    ...
    items: [
      ...
      {
        zh: "跨 provider 编排 (codex + deepseek)",
        en: "Cross-provider orchestration (codex + deepseek)",
      },
  ...
  return (
    <section className="section" id="roadmap">
      <SecHead
        ...
        label="Roadmap"
        title={t(
          { zh: "<em>公开的</em>产品节奏。", en: "A <em>public</em> product cadence." },
          lang,
        )}
        sub={t(
          {
