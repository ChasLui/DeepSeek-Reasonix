...
const INSTALL_TABS = [
  {
    id: "npx",
    label: { zh: "npx (推荐)", en: "npx (recommended)" },
    cmd: "npx reasonix code",
    note: {
      zh: "无需全局安装，进入项目目录即用",
      en: "No global install — runs in your project dir",
    },
  },
  {
    id: "npm",
  ...
  return (
    <section className="section" id="install">
      <SecHead
        ...
        label="Install"
        title={t(
          { zh: "<em>两步</em>运行，免全局安装。", en: "<em>Two steps</em>. No global install." },
          lang,
        )}
        sub={t(
          {
      ...
      >
        <div
          className="card"
          style={{ padding: "32px 28px 32px 0", borderRight: "1px solid var(--rule)" }}
        >
          <div
            style={{
              fontFamily: "var(--mono)",
            ...
            {t(
              {
                zh: (
                  <>
                    ...
                    创建一个 Key，按量计费、命中缓存的 token 仅原价 1/5。
                  </>
                ),
                en: (
                  <>
                    ...
                    and create a key. Pay-as-you-go; cached tokens bill at 1/5 of the regular rate.
                  </>
                ),
              },
              lang,
        ...
        <div
          className="card"
          style={{ padding: "32px 28px", borderRight: "1px solid var(--rule)" }}
        >
          <div
            style={{
              fontFamily: "var(--mono)",
          ...
          <div className="copy-block" style={{ fontSize: 13, maxWidth: "none" }}>
            <span className="cmd">
              <span className="tok-cmt">$ </span>cd /path/to/my-project
            </span>
          </div>
          <p
            style={{
        ...
        <div className="card" style={{ padding: "32px 0 32px 28px" }}>
          ...
          <div className="copy-block" style={{ fontSize: 13, maxWidth: "none" }}>
            <span className="cmd">
              <span className="tok-cmt">$ </span>npx reasonix code
            </span>
          </div>
          <p
            style={{
          ...
          >
            {t(
              { zh: "// 首次启动向导自动注入 Key", en: "// first-launch wizard wires up the key" },
              lang,
            )}
          </p>
        </div>
